...
Deployed and verified **2026-09-12** from **`ba6aae3a`** — the most recent commit that
...
`/verify` loads, byte for byte. Commits after `ba6aae3a` touch documentation, tests and
