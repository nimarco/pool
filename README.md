...
Deployed and verified **2026-09-12** from **`d93bcb8d`** — the most recent commit that
...
`/verify` loads, byte for byte. Commits after `d93bcb8d` touch documentation, tests and
