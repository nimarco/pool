...
Deployed and verified **2026-09-12** from **`bc0fe603`** — the most recent commit that
...
`/verify` loads, byte for byte. Commits after `bc0fe603` touch documentation, tests and
