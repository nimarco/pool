...
- **A deployed public demo** on AWS Lambda + DynamoDB at
  ...
  2026-08-22 with `us.amazon.nova-lite-v1:0` against runtime v7 — the runtime is now v8
  carrying the same coordinator, and that verification was not repeated.
...
- **A large executed test suite** — 1,308 agent tests, 75 infrastructure tests and 180
  frontend tests, reported green at **1,563 total** by `make qa` in `BUILD_HISTORY.md`
  #0063.
