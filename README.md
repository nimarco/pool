...
Deployed and verified **2026-09-12** from **`8fc64476`** — the most recent commit that
...
`/verify` loads, byte for byte. Commits after `8fc64476` touch documentation, tests and
