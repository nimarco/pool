...
Deployed and verified **2026-09-12** from **`7e8627da`** — the most recent commit that
...
`/verify` loads, byte for byte. Commits after `7e8627da` touch documentation, tests and
