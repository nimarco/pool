...
Deployed and verified **2026-09-12** from **`e8b1af33`** — the most recent commit that
...
`/verify` loads, byte for byte. Commits after `e8b1af33` touch documentation, tests and
