...
Deployed and verified **2026-09-11** from **`23c9a9c6`** — the most recent commit that
changes anything the deployed function contains, and the tree `main` still carries. You can check it without
...
Commits after `23c9a9c6` touch documentation only, so that check keeps passing as this
