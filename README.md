...
Deployed and verified **2026-09-11** from **`60729d3e`** — the most recent commit that
...
`/verify` loads, byte for byte. Commits after `60729d3e` touch documentation only, so
